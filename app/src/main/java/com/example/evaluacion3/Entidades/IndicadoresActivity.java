...
public class IndicadoresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHttp3.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                    if (response.isSuccessful()){
                        ...
                        try {
                            ...
                            IndicadoresActivity.this.runOnUiThread(() -> txtFeriados.setText(result));
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response1) throws IOException {
                if (response1.isSuccessful()) {
                    ...
                    try {
                        ...
                        IndicadoresActivity.this.runOnUiThread(() -> txtDolar.setText(result1));
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
